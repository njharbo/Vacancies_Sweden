...
\hline\hline
\multicolumn{10}{l}{\footnotesize \emph{Notes:} Standard errors in parentheses. \sym{*} \(p<0.05\), \sym{**} \(p<0.01\), \sym{***} \(p<0.001\). Standard errors clustered on the firm level. Hires: }\\
\multicolumn{10}{l}{\footnotesize hiring in month $t+1$ corrected for hires associated with newly created vacancies. Vacancies: Vacancies computed at the end of month $t$.}\\
