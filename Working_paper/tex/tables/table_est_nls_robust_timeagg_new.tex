...
\input{\datadir Data/Server/tables/table_est_nls_tax_hires_timeagg_1.tex}
\hline 
...
\hline 
\input{\datadir Data/Server/tables/table_est_nls_tax_hires_timeagg_2.tex}

\hline
			    &\multicolumn{3}{c}{\textbf{B. Survey hires}} \\
\hline

\input{\datadir Data/Server/tables/table_est_nls_survey_hires_timeagg_1.tex}
\hline 
Time fixed effects  &         Yes         &         Yes         &         Yes                      \\
[1em]
Industry dummies    &          No         &          No         &         Yes               \\
...
%Turnover dummies    &          No         &          No         &          No         &          No         &         Yes         \\
\hline 
\input{\datadir Data/Server/tables/table_est_nls_survey_hires_timeagg_2.tex}
